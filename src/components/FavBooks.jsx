...
import favBooks from "../assets/favoritebook.jpg";
  ...
  return (
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center">
      <div className="md:w-1/2">
        <img src={favBooks} className="rounded md:w-10/12" />
      </div>
      <div className="md:w-1/2 space-y-6">
        ...
        <Link to="/shop" className="mt-8 block">
          <button className="bg-blue-700 text-white font-semibold px-4 py-2 rounded
